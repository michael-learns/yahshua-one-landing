...
function Reveal({
  ...
  return (
    <div
      ref={ref}
      className={`anim${visible ? " visible" : ""}${className ? " " + className : ""}`}
...
function FeatureItem({ children }: { children: React.ReactNode }) {
  return (
    <li className="flex items-start gap-2.5 text-[#5c5878]">
      <span
  ...
  return (
    <div className="w-full max-w-xs rounded-2xl p-4 sm:p-5 bg-white shadow-sm border border-[#e8e6f0]">
      ...
      <div className="space-y-2 mb-4">
        {[
          { label: "Revenue", value: "₱1.24M", bold: false, green: false },
          { label: "Expenses", value: "₱0.81M", bold: false, green: false },
          { label: "Net Income", value: "₱430K", bold: true, green: true },
        ].map((row) => (
          <div
            key={row.label}
          ...
          >
            <div className="flex items-center gap-2.5 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <div className="text-[10px]" style={{ color: d.text }}>
                  {d.agency}
                </div>
              </div>
            </div>
      ...
      <div className="rounded-2xl p-4 bg-white shadow-sm border border-[#e8e6f0]">
        ...
        <div className="space-y-2">
          {[
            ...
            <div
              key={req.name}
              className="rounded-xl p-2.5 bg-[#f0eef9]"
            >
...
export default function V3Page() {
  ...
  return (
    <div className="text-[#1c1a2e]" style={{ fontFamily: "var(--font-geist-sans, sans-serif)" }}>
      ...
      >
        <Reveal className="flex flex-col items-center max-w-3xl w-full">
          {/* Badge */}
          <span
          ...
          {/* Headline */}
          <h1
            className="font-extrabold leading-none text-[#1c1a2e] mb-6"
            style={{
          ...
          {/* Subtext */}
          <p
            className="text-xl text-[#5c5878] max-w-lg mb-10"
      ...
      >
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <Reveal>
            <div
              className="font-light mb-4 text-[#1c1a2e]"
            ...
            <p
              className="text-lg text-[#5c5878] max-w-sm mb-6"
              style={{ lineHeight: 1.7 }}
            >
            ...
            <ul className="space-y-2.5 list-none">
              <FeatureItem>Automated SSS, PhilHealth, Pag-IBIG computation</FeatureItem>
              <FeatureItem>Payslip generation and distribution</FeatureItem>
              <FeatureItem>Timekeeping integration</FeatureItem>
            </ul>
          </Reveal>
      ...
      >
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          {/* Visual — left on desktop, top on mobile (visual comes 2nd in DOM, shown first via order) */}
          <Reveal delay={120} className="flex justify-center lg:justify-start order-2 lg:order-1">
            <AccountingMockup />
          </Reveal>
          ...
          <Reveal className="order-1 lg:order-2">
            ...
            <ul className="space-y-2.5 list-none">
              <FeatureItem>BIR-compliant journal entries</FeatureItem>
              <FeatureItem>Real-time profit &amp; loss</FeatureItem>
              <FeatureItem>Financial reports in one click</FeatureItem>
            </ul>
          </Reveal>
        </div>
      </section>
      ...
      >
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <Reveal>
            ...
            <ul className="space-y-2.5 list-none">
              <FeatureItem>Automated deadline tracking</FeatureItem>
              <FeatureItem>Smart reminders</FeatureItem>
              <FeatureItem>One-click filing summaries</FeatureItem>
            </ul>
          </Reveal>
      ...
      <section className="min-h-screen flex items-center px-6 py-24 bg-white">
        <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <Reveal className="order-1 lg:order-2">
            ...
            <ul className="space-y-2.5 list-none">
              <FeatureItem>Leave and overtime management</FeatureItem>
              <FeatureItem>Employee self-service</FeatureItem>
              <FeatureItem>Digital HR records</FeatureItem>
            </ul>
          </Reveal>
        </div>
      </section>

      {/* ── SECTION 6: FEATURE 05 — AI COPILOT ─────────────── */}
      <section
      ...
      >
        <div className="max-w-3xl mx-auto w-full text-center">
          <Reveal className="flex flex-col items-center">
            ...
            >
              Your AI-powered business assistant understands your payroll, your books, and your
              compliance. Ask in plain Filipino or English. Get instant, accurate answers.
            </p>

            {/* Chat bubbles */}
            <div className="w-full max-w-md space-y-3 text-left">
              {[
                { role: "user", text: "Magkano ang SSS contribution ni Juan this month?" },
                { role: "ai", text: "₱581.30 — based on his ₱18,000 basic salary." },
                {
                  role: "user",
                  text: "Are our BIR deadlines this month all settled?",
                },
                {
                  role: "ai",
                  text: "Yes — 2 filed, 1 due on March 25. I'll remind you 3 days before.",
                },
              ].map((msg, i) => (
                <div
                  key={i}
                ...
                >
                  <div
                    className="max-w-[85%] px-4 py-3 text-sm text-white leading-relaxed"
                    style={{
                      background:
                        msg.role === "user"
          ...
          {updates === null && (
            <div className="space-y-4">
              {[1, 2].map((i) => (
                <div
                  key={i}
                  className="bg-white rounded-xl border border-[#e8e6f0] p-6"
                >
